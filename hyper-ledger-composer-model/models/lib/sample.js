        ...
        .then(function(companyAssetRegistry) {
            ...
            return companyAssetRegistry.get(caller.company.$identifier)
                .then(function(company) {
                    ...
                    return getParticipantRegistry(namespace + ".CargoEmployee")
                        .then(function(employeeRegistry) {
                            return employeeRegistry.add(newEmployee)
                                .then(function() {
...
function AcceptCargoRequest(tx) {
    ...
    flight.cargos.push(cargoRequest.cargo);

    //Update Cargo status
    cargoRequest.cargo.status = "APPROVED";
    ...
    //Save cargos
    return saveCargo(cargoRequest.cargo).then(function() {
