...
public class Initialization {
    ...
    private void setUpDefaultAccounts() {
        ...
        try {
            ...
            JsonNode companyJsonNode = companyReply.getBody();
            ObjectNode company = (ObjectNode) Json.parse(companyJsonNode.toString());
            ...
            HttpResponse<JsonNode> updateCompanyReply =
